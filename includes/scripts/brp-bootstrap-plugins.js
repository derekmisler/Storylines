...
$(document).ready(function(){
	...
	$(pagescroll).click(function(event) {
		$(fullpage).transition({right: 0}, 500);
		$(fullpage).toggleClass('active');
		$(sidedrawerbuttontext).toggleClass("glyphicon-th-large glyphicon-remove-circle");
		$('html, body').transition({ scrollTop: $($(pagescroll).attr('href')).offset().top }, 1000, 'easeOutSine');
		event.preventDefault();
	});
