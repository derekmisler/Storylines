...
$(document).ready(function(){
	...
	v[0] = [
			"http://www.ashevillecvb.com/wp-content/uploads/2014/04/blue-ridge-parkway-clouds-loop.mp4.mp4",
			"http://www.ashevillecvb.com/wp-content/uploads/2014/04/blue-ridge-parkway-clouds-loop.webmsd.webm",
			"http://www.ashevillecvb.com/wp-content/uploads/2014/04/blue-ridge-parkway-clouds-loop.oggtheora.ogv"
			];
	v[1] = [
			"http://www.ashevillecvb.com/wp-content/uploads/2013/09/timelapse.mp4.mp4",
			"http://www.ashevillecvb.com/wp-content/uploads/2013/09/timelapse.webmhd.webm",
			"http://www.ashevillecvb.com/wp-content/uploads/2013/09/timelapse.oggtheora.ogv"
			];
	function changeVid(){
		topVideo.setAttribute("src", v[0][0]);
		topVideo.load();
	}
	function changeVidBack(){
		topVideo.setAttribute("src", v[1][0]);
		topVideo.load();
	}
	//Go!
	$('.youtube').fitVids();
	...
	topVideo.one('play', function () {
		topSlide.addClass('active').delay(2000);
	});
